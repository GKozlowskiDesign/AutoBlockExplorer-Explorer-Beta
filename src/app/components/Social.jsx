...
const Social = () => {
  return (
    <div className="grid grid-cols-1 mt-20 mb-60 w-11/12 mx-auto rounded-3xl bg-gradient-to-t from-gray-900 via-gray-900 to-blue-950 m-4 border-t-8 border-l-2 border-r-2  border-black">
   ...
   md:gap-14 bg-transparent pt-0 p-4 md:p-20 mb-20 rounded-3xl">
      {/* Twitter */}
      <div className="text-white 
      bg-gradient-to-bl from-blue-900 via-gray-900 to-black border-b-1 border-t-1 border-l-2 border-r-2 border-blue-900 shadow-2xl shadow-gray-900 
