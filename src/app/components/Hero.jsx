...
const Hero = () => {
  ...
  justify-center  bg-gradient-to-b from-blue-900 via-gray-900 to-blue-900">
           ...
           z-10  mb-96 md:mb-40 md:mt-96">
                <h1 className="text-3xl md:text-5xl justify-center flex text-white">AutoBlockExplorer</h1>
                </div>
            <div className="cols-span-1 mt-40 pt-10 md:pt-0 md:mt-0"><video     
                  autoPlay
                  loop
           ...
           z-10 mt-28 md:mt-0 bg-gradient-to-b from-blue-900 to-black p-8 rounded-br-3xl rounded-md border-b-2 border-r-2 border-black">
