...
export default function App() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-2 mx-auto p-10 md:p-20 bg-gradient-to-b from-gray-950 via-gray-800 to-gray-900 md:rounded-none">
